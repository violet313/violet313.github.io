...
function()
{
    ...
    {
        //ours
        grid:               "grid-resize-postrender-onload",
    ...
    return {run:run, resize:resize, setData:setData, onPostRender: onPostRender}
...
function()
{
    ...
    V313.modSlickgridEx5a.setData(_data);
}
)();
